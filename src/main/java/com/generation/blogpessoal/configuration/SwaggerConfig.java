    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Projeto Blog Pessoal - Higor Damasceno")
                .version("v0.0.1")
                .license(new License()
                ...
                .contact(new Contact()
                    .name("Higor Damasceno Stella")
                    .url("https://www.linkedin.com/in/higordamascenostella/")
                    .email("higordamascenostella@yahoo.com.br")))
            .externalDocs(new ExternalDocumentation()
                .description("Github")
                .url("https://github.com/Higormu2/Spring_Java.git"))
